...
int main()
{
	printf("%d %d %d %d %d %d %d %d\n", isalpha('A'), isalpha('D'), isalpha('z'), isalpha('@'), isalpha(':'), isalpha(58), isalpha(-1), isalpha(580)/* , isalpha(2147483647), isalpha(2147483648) */);
	printf("%d %d %d %d %d %d %d %d\n\n", ft_isalpha('A'), ft_isalpha('D'), ft_isalpha('z'), ft_isalpha('@'), ft_isalpha(':'), ft_isalpha(58), ft_isalpha(-1), ft_isalpha(580)/* , ft_isalpha(2147483647), ft_isalpha(2147483648) */);
